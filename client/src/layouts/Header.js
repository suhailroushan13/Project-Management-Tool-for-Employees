...
export default function Header({ onSkin }) {
  ...
  const getLeadImage = (email) => {
    // Find the lead with the matching email in leadsData
      ...
      <Dropdown className="dropdown-profile ms-3 ms-xl-4" align="end">
        <Dropdown.Toggle as={CustomToggle}>
          <div className="avatar online">
            <img src={getLeadImage(payload.email)} alt="" />
          </div>
        </Dropdown.Toggle>
        <Dropdown.Menu className="mt-10-f">
          <div className="dropdown-menu-body">
            ...
            <h5 className="mb-1 text-dark fw-semibold">Admin Panel </h5>
            <p className="fs-sm text-secondary">Admin</p>

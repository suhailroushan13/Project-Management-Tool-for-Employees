...
//   try {
//     // Fetch only projects that have associated comments
//     const projects = await Project.findAll({
//       include: [
//         {
//           model: Comment,
//           required: true, // This ensures only projects with comments are returned
//         },
//         {
//           model: User,
//           required: true, // This ensures only projects with comments are returned
...
//     // Extract the comments from each project and create an array of projects with comments
//     const projectsWithComments = projects.map((project) => {
//       return {
//         projectId: project.id,
//         comments: project.comments, // Extracting associated comments
//       };
//     });
